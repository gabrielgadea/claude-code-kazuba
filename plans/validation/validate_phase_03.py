#!/usr/bin/env python3
"""
Validation Script — Phase 3: Hooks Essential Module
...
PHASE_ID = 3
PHASE_TITLE = "Hooks Essential Module"
BASE_DIR = Path(__file__).resolve().parent.parent.parent
CHECKPOINT_DIR = BASE_DIR / "checkpoints"
CHECKPOINT_DIR.mkdir(exist_ok=True)

EXPECTED_FILES = [
    "modules/hooks-essential/MODULE.md",
"modules/hooks-essential/hooks/prompt_enhancer.py",
"modules/hooks-essential/hooks/prompt_enhancer_config.yaml",
"modules/hooks-essential/hooks/status_monitor.sh",
"modules/hooks-essential/hooks/check_context.sh",
"modules/hooks-essential/hooks/auto_compact.sh",
"modules/hooks-essential/hooks/compact_reinjector.py",
"modules/hooks-essential/settings.hooks.json"
]
MIN_LINES = {"modules/hooks-essential/MODULE.md": 30, "modules/hooks-essential/hooks/prompt_enhancer.py": 400, "modules/hooks-essential/hooks/prompt_enhancer_config.yaml": 80, "modules/hooks-essential/hooks/status_monitor.sh": 60, "modules/hooks-essential/hooks/check_context.sh": 25, "modules/hooks-essential/hooks/auto_compact.sh": 30, "modules/hooks-essential/hooks/compact_reinjector.py": 50, "modules/hooks-essential/settings.hooks.json": 30}
