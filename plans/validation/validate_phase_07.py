#!/usr/bin/env python3
"""
Validation Script — Phase 7: Config + Contexts + Team Orchestrator
...
PHASE_ID = 7
PHASE_TITLE = "Config + Contexts + Team Orchestrator"
BASE_DIR = Path(__file__).resolve().parent.parent.parent
CHECKPOINT_DIR = BASE_DIR / "checkpoints"
CHECKPOINT_DIR.mkdir(exist_ok=True)

EXPECTED_FILES = [
    "modules/config-hypervisor/MODULE.md",
"modules/config-hypervisor/config/hypervisor.yaml",
"modules/config-hypervisor/config/agent_triggers.yaml",
"modules/config-hypervisor/config/event_mesh.yaml",
"modules/contexts/MODULE.md",
"modules/contexts/contexts/dev.md",
"modules/contexts/contexts/review.md",
"modules/contexts/contexts/research.md",
"modules/contexts/contexts/audit.md",
"modules/team-orchestrator/MODULE.md",
"modules/team-orchestrator/config/agents.yaml",
"modules/team-orchestrator/config/routing_rules.yaml",
"modules/team-orchestrator/config/sla.yaml",
"modules/team-orchestrator/src/models.py",
"modules/team-orchestrator/templates/task-delegation.md",
"modules/team-orchestrator/templates/status-report.md"
]
MIN_LINES = {"modules/config-hypervisor/MODULE.md": 20, "modules/config-hypervisor/config/hypervisor.yaml": 80, "modules/config-hypervisor/config/agent_triggers.yaml": 60, "modules/config-hypervisor/config/event_mesh.yaml": 50, "modules/contexts/MODULE.md": 20, "modules/contexts/contexts/dev.md": 30, "modules/contexts/contexts/review.md": 30, "modules/contexts/contexts/research.md": 30, "modules/contexts/contexts/audit.md": 30, "modules/team-orchestrator/MODULE.md": 20, "modules/team-orchestrator/config/agents.yaml": 40, "modules/team-orchestrator/config/routing_rules.yaml": 40, "modules/team-orchestrator/config/sla.yaml": 30, "modules/team-orchestrator/src/models.py": 150, "modules/team-orchestrator/templates/task-delegation.md": 20, "modules/team-orchestrator/templates/status-report.md": 20}
