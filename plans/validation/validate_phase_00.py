#!/usr/bin/env python3
"""
Validation Script — Phase 0: Bootstrap & Scaffolding
...
PHASE_ID = 0
PHASE_TITLE = "Bootstrap & Scaffolding"
...
MIN_LINES = {"pyproject.toml": 40, ".gitignore": 20, "LICENSE": 20, "README.md": 50, "lib/__init__.py": 5, "tests/__init__.py": 1, "tests/conftest.py": 20, ".claude/CLAUDE.md": 30, ".claude/settings.json": 20}
