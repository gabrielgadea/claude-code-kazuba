#!/usr/bin/env python3
"""
Validation Script — Phase 5: Hooks Routing + Knowledge + Metrics
...
PHASE_ID = 5
PHASE_TITLE = "Hooks Routing + Knowledge + Metrics"
BASE_DIR = Path(__file__).resolve().parent.parent.parent
CHECKPOINT_DIR = BASE_DIR / "checkpoints"
CHECKPOINT_DIR.mkdir(exist_ok=True)

EXPECTED_FILES = [
    "modules/hooks-routing/MODULE.md",
"modules/hooks-routing/hooks/intent_router.py",
"modules/hooks-routing/hooks/intent_patterns.py",
"modules/hooks-routing/hooks/strategy_enforcer.py",
"modules/hooks-routing/settings.hooks.json",
"modules/hooks-knowledge/MODULE.md",
...
"modules/hooks-knowledge/settings.hooks.json",
"modules/hooks-metrics/MODULE.md",
"modules/hooks-metrics/hooks/compliance_collector.py",
"modules/hooks-metrics/hooks/compliance_dashboard.py",
"modules/hooks-metrics/settings.hooks.json"
]
MIN_LINES = {"modules/hooks-routing/MODULE.md": 30, "modules/hooks-routing/hooks/intent_router.py": 120, "modules/hooks-routing/hooks/intent_patterns.py": 80, "modules/hooks-routing/hooks/strategy_enforcer.py": 60, "modules/hooks-routing/settings.hooks.json": 20, "modules/hooks-knowledge/MODULE.md": 30, "modules/hooks-knowledge/hooks/knowledge_retrieval.py": 100, "modules/hooks-knowledge/hooks/knowledge_capture.py": 80, "modules/hooks-knowledge/hooks/session_context.py": 60, "modules/hooks-knowledge/settings.hooks.json": 20, "modules/hooks-metrics/MODULE.md": 30, "modules/hooks-metrics/hooks/compliance_collector.py": 80, "modules/hooks-metrics/hooks/compliance_dashboard.py": 100, "modules/hooks-metrics/settings.hooks.json": 20}
