#!/usr/bin/env python3
"""
Validation Script — Phase 8: Installer CLI
...
"presets/professional.txt",
"presets/enterprise.txt",
"presets/research.txt"
]
MIN_LINES = {"install.sh": 300, "scripts/install_module.py": 150, "scripts/merge_settings.py": 100, "scripts/detect_stack.py": 60, "scripts/resolve_deps.py": 80, "scripts/validate_installation.py": 80, "presets/minimal.txt": 5, "presets/standard.txt": 10, "presets/professional.txt": 15, "presets/enterprise.txt": 18, "presets/research.txt": 12}
