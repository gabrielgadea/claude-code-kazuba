#!/usr/bin/env python3
"""
Validation Script — Phase 2: Core Module
...
"core/settings.local.json.template",
"core/.gitignore.template",
"core/MODULE.md",
"core/rules/code-style.md",
"core/rules/security.md",
"core/rules/testing.md",
"core/rules/git-workflow.md"
]
MIN_LINES = {"core/CLAUDE.md.template": 150, "core/settings.json.template": 60, "core/settings.local.json.template": 20, "core/.gitignore.template": 15, "core/MODULE.md": 30, "core/rules/code-style.md": 50, "core/rules/security.md": 60, "core/rules/testing.md": 40, "core/rules/git-workflow.md": 40}
