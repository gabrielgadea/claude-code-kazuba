#!/usr/bin/env python3
"""
Validation Script — Phase 1: Shared Library (lib/)
...
PHASE_ID = 1
PHASE_TITLE = "Shared Library (lib/)"
...
MIN_LINES = {"lib/hook_base.py": 120, "lib/patterns.py": 150, "lib/performance.py": 100, "lib/json_output.py": 80, "lib/config.py": 200, "lib/checkpoint.py": 80, "lib/template_engine.py": 60}
