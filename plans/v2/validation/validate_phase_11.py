#!/usr/bin/env python3
"""
Validation Script — Phase 11: Shared Infrastructure
...
PHASE_ID = 11
PHASE_TITLE = "Shared Infrastructure"
...
MIN_LINES = {"lib/circuit_breaker.py": 200, "lib/trace_manager.py": 80, "lib/hook_logger.py": 80, "lib/event_bus.py": 100}
TEST_DIR = "tests/phase_11/"
MIN_COVERAGE = 90
...
TEST_SPECS = [
    ("tests/phase_11/test_circuit_breaker.py", 20, 90),
    ("tests/phase_11/test_trace_manager.py", 15, 90),
    ("tests/phase_11/test_hook_logger.py", 10, 90),
    ("tests/phase_11/test_event_bus.py", 15, 90),
]
