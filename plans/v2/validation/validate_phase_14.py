#!/usr/bin/env python3
"""
Validation Script — Phase 14: Agent Triggers + Recovery Triggers
...
PHASE_ID = 14
PHASE_TITLE = "Agent Triggers + Recovery Triggers"
...
# Python files to measure coverage for (separate from YAML deliverables)
COVERAGE_FILES = ["lib/config.py"]
MIN_LINES = {"modules/config-hypervisor/config/agent_triggers.yaml": 180, "modules/config-hypervisor/config/recovery_triggers.yaml": 90}
TEST_DIR = "tests/phase_14/"
MIN_COVERAGE = 90
...
TEST_SPECS = [
    ("tests/phase_14/test_agent_triggers.py", 14, 90),
    ("tests/phase_14/test_recovery_triggers.py", 10, 90),
]
