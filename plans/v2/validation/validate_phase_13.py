#!/usr/bin/env python3
"""
Validation Script — Phase 13: Core Governance + CILA Formal
...
PHASE_ID = 13
PHASE_TITLE = "Core Governance + CILA Formal"
...
# Python files to measure coverage for (Markdown files cannot have Python coverage)
COVERAGE_FILES = ["lib/governance.py"]
MIN_LINES = {"core/rules/core-governance.md": 200, "core/rules/agent-teams.md": 150, "modules/hooks-routing/config/cila-taxonomy.md": 50, "lib/governance.py": 200, "modules/hooks-routing/hooks/strategy_enforcer.py": 120}
TEST_DIR = "tests/phase_13/"
MIN_COVERAGE = 90
...
TEST_SPECS = [
    ("tests/phase_13/test_governance.py", 15, 90),
    ("tests/phase_13/test_strategy_enforcer.py", 10, 90),
]
