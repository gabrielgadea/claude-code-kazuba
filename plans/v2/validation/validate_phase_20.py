#!/usr/bin/env python3
"""
Validation Script — Phase 20: Benchmarks + Self-Hosting
...
PHASE_ID = 20
PHASE_TITLE = "Benchmarks + Self-Hosting"
BASE_DIR = Path(__file__).resolve().parent.parent.parent.parent
CHECKPOINT_DIR = BASE_DIR / "checkpoints"
CHECKPOINT_DIR.mkdir(exist_ok=True)

EXPECTED_FILES = [
    "scripts/benchmark_hooks.py",
    ".claude/hooks/self_host_config.py"
]
MIN_LINES = {"scripts/benchmark_hooks.py": 200, ".claude/hooks/self_host_config.py": 50}
# Python files to measure coverage for
COVERAGE_FILES = [
    "scripts/benchmark_hooks.py",
    ".claude/hooks/self_host_config.py"
]
TEST_DIR = "tests/phase_20/"
MIN_COVERAGE = 90
...
TEST_SPECS = [
    ("tests/phase_20/test_benchmark_runner.py", 10, 90),
    ("tests/phase_20/test_self_hosting.py", 10, 90),
]
