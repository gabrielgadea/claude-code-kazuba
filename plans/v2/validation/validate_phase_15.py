#!/usr/bin/env python3
"""
Validation Script — Phase 15: Hypervisor Executable
...
PHASE_ID = 15
PHASE_TITLE = "Hypervisor Executable"
...
MIN_LINES = {"modules/config-hypervisor/src/hypervisor.py": 180, "modules/config-hypervisor/src/hypervisor_v2.py": 140, "modules/config-hypervisor/src/hypervisor_bridge.py": 130}
...
def run_tests() -> dict:
    ...
    result = subprocess.run(
        [
            ...
            "--tb=short", "-q",
            f"--cov={BASE_DIR / 'lib'}",
            f"--cov={BASE_DIR / 'modules/config-hypervisor'}",
...
TEST_SPECS = [
    ("tests/phase_15/test_hypervisor.py", 15, 90),
    ("tests/phase_15/test_hypervisor_v2.py", 10, 90),
    ("tests/phase_15/test_hypervisor_bridge.py", 10, 90),
]
