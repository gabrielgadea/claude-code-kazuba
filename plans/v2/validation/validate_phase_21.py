#!/usr/bin/env python3
"""
Validation Script — Phase 21: Documentation + CI Update
...
PHASE_ID = 21
PHASE_TITLE = "Documentation + CI Update"
...
MIN_LINES = {"docs/MIGRATION.md": 80}
# docs/MIGRATION.md is a Markdown file — no Python coverage to measure
COVERAGE_FILES: list[str] = []
TEST_DIR = "tests/phase_21/"
MIN_COVERAGE = 90
...
TEST_SPECS = [
    ("tests/phase_21/test_doc_links.py", 10, 90),
    ("tests/phase_21/test_doc_completeness.py", 8, 90),
]
